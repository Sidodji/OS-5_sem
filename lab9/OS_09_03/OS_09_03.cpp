...
int main() {
	...
	LPCWSTR file = L"D:\\Laboratory\\OS\\lab9\\OS_09_03\\test.txt";
	LPCWSTR srt1 = L"STRING";
  ...
  //  insRowFileTxt(LPWSTR(file), LPWSTR(srt1), 20);
...
bool insRowFileTxt(LPWSTR  FileName, LPWSTR str, DWORD row) {
    ...
    default:
        ...
        char* start = new char[nPosition];
        for (int i = 0; i < nPosition; i++) start[i] = buf[i];
