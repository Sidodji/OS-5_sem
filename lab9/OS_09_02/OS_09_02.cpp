...
int main()
{
    ...
    if (!delRowFileTxt((LPWSTR)L"os_09_02.txt", 1))
        cout << "Error del" << endl;
    
    //delRowFileTxt((LPWSTR)L"os_09_02.txt", 3);
    //delRowFileTxt((LPWSTR)L"os_09_02.txt", 8);
    delRowFileTxt((LPWSTR)L"D:\\Laboratory\\OS\\lab9\\OS_09_02\\os_09_02.txt", 3);
    printFileTxt((LPWSTR)L"D:\\Laboratory\\OS\\lab9\\OS_09_02\\os_09_02.txt");
}
